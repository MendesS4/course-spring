...
import com.mendes.project_spring.entities.*;
import com.mendes.project_spring.entities.enums.OrderStatus;
import com.mendes.project_spring.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        OrderItem oi2 = new OrderItem(o1, p3, 4, p3.getPrice());
        OrderItem oi3 = new OrderItem(o2, p3, 1, p3.getPrice());
        OrderItem oi4 = new OrderItem(o3, p5, 5, p5.getPrice());

        orderItemRepository.saveAll(Arrays.asList(oi1, oi2, oi3, oi4));

        Payment pay1 = new Payment(null, Instant.parse("2025-08-22T19:53:07Z"), o1);
        o1.setPayment(pay1);
